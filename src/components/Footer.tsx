export default function Footer() {
  return (
    <footer className="bg-[#080A16] text-white pt-16 pb-8 w-full">
      <div className="max-w-[1400px] mx-auto px-3 lg:px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <div className="text-2xl font-bold mb-3" style={{ color: '#d1ab35' }}>
                TTT POS
              </div>
            ...
            <div className="flex gap-3 mt-6">
              <a
                href="#"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#d1ab35] flex items-center justify-center transition-all duration-300"
              >
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-xs">
              <p>© 2025 TTT POS. All rights reserved.</p>
            </div>
